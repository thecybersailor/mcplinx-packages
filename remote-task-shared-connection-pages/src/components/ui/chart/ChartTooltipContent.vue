...
const props = withDefaults(defineProps<{
  ...
  indicator?: "line" | "dot" | "dashed"../labelFormatter?: (d: number | Date) => string
...
const nestLabel = computed(() => Object.keys(props.payload).length === 1 && props.indicator !== "dot"../labelKey] : props.x
})
</script>
        ...
        >
          ...
          <div :class="cn('flex flex-1 justify-between leading-none', nestLabel ? 'items-end' : 'items-center')">
            <div class="grid gap-1.5">
              ...
              <span class="text-muted-foreground"../label || value }}
              </span>
            </div>
