      ...
      <div class="space-y-4">
        <BundlePanel>
          ...
          <div class="flex flex-col gap-2">
            ...
            <button class="inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-100" @click="router.push({ name: `${runtime.routePrefix}-connections` })">
              Back to Connections
            </button>
          </div>
        </BundlePanel>
